...
--
-- Host: mariadb:3306
-- Generation Time: Sep 24, 2026 at 02:36 PM
...
--
ALTER TABLE `curriculums`
  ADD CONSTRAINT `curriculums_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`),
  ADD CONSTRAINT `curriculums_ibfk_2` FOREIGN KEY (`parent_id`) REFERENCES `curriculums` (`id`),
  ADD CONSTRAINT `curriculums_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`);
